...
@Composable
fun AssetTheme(
    theme: AssetTheme.Theme = AssetTheme.Theme.Light,
    content: @Composable () -> Unit
) {

    val targetColors = when (theme) {
        AssetTheme.Theme.Light -> {
            LightColorPalette.themeUi = themeColor
            LightColorPalette.primaryBtnBg = themeColor
            LightColorPalette
        }
        AssetTheme.Theme.Dark -> DarkColorPalette
    }
    ...
    systemUiCtrl.setNavigationBarColor(appColors.mainColor)
